...
// API Configuration
export const API_URL = import.meta.env.VITE_API_URL || 'https://gitb-admissions.preview.emergentagent.com/api';
export const LMS_URL = import.meta.env.VITE_LMS_URL || 'https://gitb-admissions.preview.emergentagent.com';

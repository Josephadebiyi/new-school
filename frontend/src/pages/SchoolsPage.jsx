      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {selectedSchool ? (
            // School Detail View
            <div>
              <Link to="/schools" className="inline-flex items-center text-[#7ebf0d] hover:underline mb-8">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-xl p-6 text-center">
                      <BookOpen className="w-8 h-8 text-[#7ebf0d] mx-auto mb-2" />
                      <p className="text-2xl font-bold text-gray-900">{selectedSchool.courses}</p>
                      <p className="text-sm text-gray-600">Programs</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 text-center">
                      <Users className="w-8 h-8 text-[#7ebf0d] mx-auto mb-2" />
                  ...
                  <div className="bg-[#314a06] text-white rounded-xl p-6">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-center gap-2">
                        <Users className="w-5 h-5 text-[#7ebf0d]" />
                        Expert instructors
                      </li>
                      <li className="flex items-center gap-2">
                        <Clock className="w-5 h-5 text-[#7ebf0d]" />
                ...
                {selectedSchool.programs.map((program, index) => (
                  <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
                      ...
                      <span className="px-2 py-1 bg-[#7ebf0d]/10 text-[#314a06] text-xs rounded-full">
                        {program.level}
                      </span>
                    </div>
                    {program.link ? (

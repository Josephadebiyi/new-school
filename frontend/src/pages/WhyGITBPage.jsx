...
const WhyGITBPage = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-white pt-[72px]" data-testid="why-gitb-page">
      ...
      {/* Stats */}
      <section className="py-16 bg-[#7ebf0d]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="reveal opacity-0 bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow"
                  style={{ animationDelay: `${0.3 + index * 0.1}s` }}
                >
                  <div className="w-14 h-14 bg-[#7ebf0d]/10 rounded-xl flex items-center justify-center mb-6">
                    <Icon className="w-7 h-7 text-[#7ebf0d]" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {differentiators.map((item, index) => (
              ...
              >
                <CheckCircle className="w-5 h-5 text-[#7ebf0d] flex-shrink-0" />
